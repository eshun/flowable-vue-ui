        ...
        */
        ...
        this.getProfile = function () {
            return httpAsPromise(
                {
                    method: 'GET',
                    url: FLOWABLE.CONFIG.serviceRoot + '/app/rest/admin/profile'
                }
            )
        };
        ...
        this.changePassword = function(oldPassword, newPassword) {
            return httpAsPromise(
                {
                    method: 'POST',
                    url: FLOWABLE.CONFIG.serviceRoot + '/app/rest/admin/profile-password',
        ...
        */
        ...
        this.getGroup = function (groupId, includeAllUsers) {
            ...
            return httpAsPromise(
                {
                    method: 'GET',
                    url: FLOWABLE.CONFIG.serviceRoot + '/app/rest/admin/groups/' + groupId,
                    params: params
                }
            )
        };
        ...
        this.getUsersForGroup = function(groupId, filter, page, pageSize) {
            ...
            return httpAsPromise(
                {
                    method: 'GET',
                    url: FLOWABLE.CONFIG.serviceRoot + '/app/rest/admin/groups/' + groupId + '/users',
                    params: params
                }
            )
        ...
        this.activateGroup = function(groupId) {
            return httpAsPromise(
                {
                    method: 'POST',
                    url: FLOWABLE.CONFIG.serviceRoot + '/app/rest/admin/groups/' + groupId + '/action/activate'
                }
            )
        };
        ...
        this.deleteGroupMember = function(groupId, userId) {
            return httpAsPromise(
                {
                    method: 'DELETE',
                    url: FLOWABLE.CONFIG.serviceRoot + '/app/rest/admin/groups/' + groupId + '/members/' + userId
                }
            )
        };
        ...
        this.getPrivileges = function() {
            return httpAsPromise({
                method: 'GET',
                url: FLOWABLE.CONFIG.serviceRoot + '/app/rest/admin/privileges'
            })
        };
        ...
        this.getPrivilege = function(privilegeId) {
            return httpAsPromise({
                method: 'GET',
                url: FLOWABLE.CONFIG.serviceRoot + '/app/rest/admin/privileges/' + privilegeId
            });
        };
        ...
        this.addUserPrivilege = function(privilegeId, userId) {
            return httpAsPromise(
                {
                    method: 'POST',
                    url: FLOWABLE.CONFIG.serviceRoot + '/app/rest/admin/privileges/' + privilegeId + '/users',
                    data: { userId : userId}
                }
            )
        };
        ...
        this.deleteUserPrivilege = function(privilegeId, userId) {
            return httpAsPromise(
                {
                    method: 'DELETE',
                    url: FLOWABLE.CONFIG.serviceRoot + '/app/rest/admin/privileges/' + privilegeId + '/users/' + userId
                }
            )
        };
        ...
        this.addGroupPrivilege = function(privilegeId, groupId) {
            return httpAsPromise(
                {
                    method: 'POST',
                    url: FLOWABLE.CONFIG.serviceRoot + '/app/rest/admin/privileges/' + privilegeId + '/groups',
        ...
        this.deleteGroupPrivilege = function(privilegeId, groupId) {
            return httpAsPromise(
                {
                    method: 'DELETE',
                    url: FLOWABLE.CONFIG.serviceRoot + '/app/rest/admin/privileges/' + privilegeId + '/groups/' + groupId
                }
            )
        };
